------- OpenFAST INPUT FILE -------------------------------------------
FAST driver input file, converted from FAST v8 to OpenFAST v3.5.5
---------------------- SIMULATION CONTROL --------------------------------------
True                   Echo        - Echo input data to <RootName>.ech (flag)
"FATAL"                AbortLevel  - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
8481.0     TMax        - Total run time (s) 
0.03125     DT          - Recommended module time step (s): 1/32s = 0.03125 (rpm 9.33) corresponds to 1.749 deg/timestep
...
1.4857142857142855e-05               KinVisc     - Kinematic viscosity of working fluid (m^2/s)
...
---------------------- INPUT FILES ---------------------------------------------
"ElastoDyn/ElastoDyn_HubHeight92m.dat" EDFile      - Name of file containing ElastoDyn input parameters (quoted string)
...
"InflowWind/InflowWind.dat" InflowFile  - Name of file containing inflow wind input parameters (quoted string)
"AeroDyn15/AeroDyn15.dat" AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"ServoDyn/ServoDyn.dat"               ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
...
0.0625     DT_Out      - Time step for tabular output (s) (or "default") : 0.01262626... = 2*DT (for rpm 13.2=79.2 deg/s) corresponds to a rotation by 1 deg
...
False         CalcSteady      - Calculate a steady-state periodic operating point before linearization? [unused if Linearize=False] (flag)
  ...
  10.0,20.0   LinTimes        - List of times at which to linearize (s) [1 to NLinTimes] [used only when Linearize=True and CalcSteady=False]
