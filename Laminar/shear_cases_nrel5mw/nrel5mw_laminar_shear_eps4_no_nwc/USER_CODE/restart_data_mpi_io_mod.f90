...
!-- PALM interfaces
    ...
    INTERFACE rrd_mpi_io_global_array
     ...
     MODULE PROCEDURE rrd_mpi_io_global_array_real_5d
    ...
    INTERFACE wrd_mpi_io_global_array
     ...
     MODULE PROCEDURE wrd_mpi_io_global_array_real_5d
...
!-- int_names and real_names are extended from 32 to 64 characters.
    ...
    text_lines   = ' '
    real_names   = ' '
    real_values  = 0.0_wp  ! S.ouchene: added _wp suffix to set the correct real kind
    array_names  = ' '
    array_offset = 0
...
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE rrd_mpi_io_real( name, value )
    ...
    found = .FALSE.
    value = 0.0_wp    ! s.ouchene: add the _wp suffix to set the correct REAL kind.
...
! Description:
! ------------
!> Read 5d-REAL global array with MPI-IO.
!> Array contains identical data on all PEs.
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE rrd_mpi_io_global_array_real_5d( name, data )
 ...
 END SUBROUTINE rrd_mpi_io_global_array_real_5d
...
! Description:
! ------------
!> Write 5d-REAL global array with MPI-IO.
!> Array contains identical data on all PEs.
!--------------------------------------------------------------------------------------------------!
 SUBROUTINE wrd_mpi_io_global_array_real_5d( name, data )
 ...
 END SUBROUTINE wrd_mpi_io_global_array_real_5d
