...
"FATAL"       AbortLevel      - Error level when simulation should abort (string) {"WARNING", "SEVERE", "FATAL"}
        300.5  TMax            - Total run time (s). Larger than the PALM end_time (300 s) so OpenFAST outlives the PALM run.
   0.015625   DT              - Module time step (s). PALM uses dt = this (0.015625 s, ALM mode), so PALM and FAST advance 1:1.
...
---------------------- INPUT FILES ---------------------------------------------
"ElastoDyn/ElastoDyn_0_tilt_504mHub.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string). Reused from the AD14 sibling case; ED is identical between AD14 and AD15 paths.
